...
@RequestMapping(path="/ecommerce") // This means URL's start with /demo (after Application path)
public class MainController {
    ...
    public @ResponseBody String existsCustomer(@RequestParam String email){
        Integer i = CustomerRepository.countByEmail(email);
        return i > 0 ? "Exists" : "Not Exists";
    }
}